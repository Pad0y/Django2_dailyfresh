...
class OrderInfo(BaseModel):
    ...
    addr = models.ForeignKey(
        "user.Address", verbose_name="地址", on_delete=models.CASCADE
    )
...
class OrderGoods(BaseModel):
    ...
    order = models.ForeignKey(
        "OrderInfo", verbose_name="订单", on_delete=models.DO_NOTHING
    )
    sku = models.ForeignKey(
        "goods.GoodsSKU", verbose_name="商品SKU", on_delete=models.DO_NOTHING
    )
